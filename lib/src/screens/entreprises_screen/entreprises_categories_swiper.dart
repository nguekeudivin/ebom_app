...
class EntreprisesCategoriesSwiper extends StatefulWidget {
  const EntreprisesCategoriesSwiper({super.key});

  @override
  State<EntreprisesCategoriesSwiper> createState() =>
      _EntreprisesCategoriesSwiperState();
}

class _EntreprisesCategoriesSwiperState
    extends State<EntreprisesCategoriesSwiper> {
  @override
