...
class ServicesCategoriesSlide extends StatefulWidget {
  const ServicesCategoriesSlide({super.key});

  @override
  State<ServicesCategoriesSlide> createState() =>
      ServicesCategoriesSlideState();
}

class ServicesCategoriesSlideState extends State<ServicesCategoriesSlide> {
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      Provider.of<AppLayoutNavigationProvider>(
                        context,
                        listen: false,
                      ).setActiveScreen('services_screen');
                    },
                    child: Container(
                      width: 100,
