...
class EntreprisesTypesScreen extends StatefulWidget {
  const EntreprisesTypesScreen({super.key});

  @override
  State<EntreprisesTypesScreen> createState() => _CategoriesScreenState();
}

class _CategoriesScreenState extends State<EntreprisesTypesScreen> {
